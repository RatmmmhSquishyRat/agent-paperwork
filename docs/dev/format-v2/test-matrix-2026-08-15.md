...
3. **既有基线未受扰动**：char_tests 38 项黄金快照零 diff（全绿）；cli_integration 41、t6_cli_tests 4、core 209（单元 109 + ops 71 + guard 23 + roundtrip 12，其中 char_tests roundtrip 12 归属 paperwork-core）原样存活；新增 16 项纯新增文件 `ivy_gap_tests.rs`，无任何既有源码/测试被修改。
